...
const _applesigninauth = /*#__PURE__*/ _interop_require_default(require("apple-signin-auth"));
...
class AppleSignInService {
   ...
   */ async verifyIdToken(idToken, clientId, source = 'unknown') {
        ...
        try {
            ...
            try {
                decodedToken = _jsonwebtoken.default.decode(idToken, {
                    complete: false
                });
            ...
            try {
                ...
                appleRes = await _applesigninauth.default.verifyIdToken(idToken, {
   ...
   */ async getAuthorizationToken(code) {
        ...
        return _applesigninauth.default.getAuthorizationToken(code, {
   ...
   */ async refreshAuthorizationToken(refreshToken) {
        const clientSecret = this.generateClientSecret();
        return _applesigninauth.default.refreshAuthorizationToken(refreshToken, {
            clientID: this.clientId,
            clientSecret: clientSecret
        });
    }
   ...
   */ async getApplePublicKeys() {
        return _applesigninauth.default.getAuthorizationToken.getApplePublicKeys();
    }
    /**
...
const _default = appleSignInService;

//# sourceMappingURL=apple-signin.service.js.map