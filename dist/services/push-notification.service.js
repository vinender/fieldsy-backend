...
class PushNotificationService {
   ...
   */ static async sendToUser(payload) {
        ...
        try {
            ...
            deviceTokens.forEach((dt)=>{
                if (_exposerversdk.Expo.isExpoPushToken(dt.token)) {
   ...
   */ static getNotificationContent(type, data) {
        ...
        const baseUrl = _constants.FRONTEND_URL;
...
const _default = PushNotificationService;
