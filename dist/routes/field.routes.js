...
router.get('/', rateLimiter_middleware_1.generalLimiter, auth_middleware_2.optionalAuth, field_controller_1.default.getAllFields);
router.get('/active', rateLimiter_middleware_1.generalLimiter, auth_middleware_2.optionalAuth, field_controller_1.default.getActiveFields); // Public endpoint for active fields only (with isLiked if authenticated)
...
router.get('/:id/google-reviews', field_controller_1.default.getGoogleReviews);
...
router.patch('/:fieldId/entry-code', (0, auth_middleware_1.restrictTo)('FIELD_OWNER'), field_controller_1.default.updateEntryCode);
