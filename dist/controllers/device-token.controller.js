...
exports.deviceTokenController = {
    ...
    async registerToken(req, res) {
        try {
            ...
            const deviceToken = await database_1.default.deviceToken.upsert({
                where: { token },
                update: {
    ...
    async removeToken(req, res) {
        try {
            ...
            const result = await database_1.default.deviceToken.updateMany({
                where: {
                    token,
    ...
    async getUserTokens(req, res) {
        try {
            ...
            const tokens = await database_1.default.deviceToken.findMany({
...
exports.default = exports.deviceTokenController;
