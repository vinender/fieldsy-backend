...
const deviceTokenController = {
   ...
   */ async registerToken (req, res) {
        try {
            ...
            const deviceToken = await _database.default.deviceToken.upsert({
                where: {
                    token
                },
                update: {
   ...
   */ async removeToken (req, res) {
        try {
            ...
            const result = await _database.default.deviceToken.updateMany({
                where: {
                    token,
   ...
   */ async getUserTokens (req, res) {
        try {
            ...
            const tokens = await _database.default.deviceToken.findMany({
                where: {
                    userId,
                    isActive: true
                },
...
const _default = deviceTokenController;
